...
@section('front')
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="row">
                        ...
                        <div class="col-lg-12 col-md-12">
                            <br>
                            @if (Session::has('bill_save'))
                                <h3 class="text-center">{{Session::get('bill_save')}}</h3>
                            @endif
                                ...
                                <div class="tab-pane fade show active" id="dashboad" role="tabpanel">
                                    <div class="myaccount-content">
                                        ...
                                        <div class="account-details-form">
                                            <form action="{{route('my.billing.save')}}" method="post" name="billform">
                                                @csrf
                                                <div class="row">
                                                    <div class="col-lg-12">
                                                        <div class="single-input-item">
                                                            <label for="first-name" class="required">Address*</label>
                                                            <input type="text" name="address" value="{{$bill->address}}" id="first-name">
                                                        </div>
                                                    </div>
                                                    <div class="col-lg-6">
                                                        <div class="single-input-item">
                                                    ...
                                                    <div class="col-lg-6">
                                                        <div class="single-input-item">
                                                            ...
                                                            <input type="text" name="town_city" value="{{$bill->town_city}}" id="last-name">
                                                        </div>
                                                    </div>
                                                    <div class="col-lg-6">
                                                        <div class="single-input-item">
                                                            <label for="last-name" class="required">State</label>
                                                            <input type="text" name="state" value="{{$bill->state}}" id="last-name">
                                                        </div>
                                                    </div>
                                                    <div class="col-lg-6">
                                                        <div class="single-input-item">
                                                            <label for="last-name" class="required">Zip Code</label>
                                                            <input type="text" name="zip_code" value="{{$bill->zip_code}}" id="last-name">
                                                        </div>
                                                    </div>
                                                </div>
    ...
    <script>
        document.forms['billform'].elements['country'].value="{{$bill->country}}";
    </script>
@stop
